                    ...
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <div class="text-center shrink-0">
                            ...
                            <button type="button" wire:click="$set('showPosterModal', true)" class="relative group">
                                <img src="{{ $posterUrl }}"
                                    class="w-28 h-28 aspect-[4/5] object-contain rounded-xl border border-slate-200 transition-transform group-hover:scale-105" alt="Generated Poster">
        ...
        <div class="relative w-full max-w-lg transform transition-all"
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div class="p-4 bg-white flex items-center justify-between">
                    <p class="text-sm font-medium text-slate-900">Poster By Carita AI</p>
