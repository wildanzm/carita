<div>
    <div class="glassmorphism rounded-2xl p-8 shadow-lg">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800">{{ __('Two Factor Authentication') }}</h2>
            <p class="text-gray-600 mt-1">{{ __('Manage your two-factor authentication settings') }}</p>
        </div>
